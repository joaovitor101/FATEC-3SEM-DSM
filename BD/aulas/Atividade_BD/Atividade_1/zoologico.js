...
async function main() {
    ...
    try {
        ...
        await animais.insertMany([
            ...
            { nome: "Zara", especie: "Leopardo", idade: 5, dieta: "Carnívoro", habitat: "Savana", vacinado: false },
        ...
        //     { especie: { $in: ["Leão", "Leopardo"] } }, { $set: { vacinado: true } }
        // );
...
db.animais.updateMany({ especie: { $in: ["Leão", "Leopardo"] } }, { $set: { vacinado: true } })
